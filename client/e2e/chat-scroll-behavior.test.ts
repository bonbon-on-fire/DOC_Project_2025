...
Just confirming scroll behavior`;
    ...
    console.log('✅ Test 1 completed: Auto-scroll behavior verified for both sending and receiving');
  });
...
This is the second message`;
  ...
  const isStillAtBottom = scrollPosition.distanceFromBottom < 150;
    ...
    console.log('✅ Step 2d completed: Auto-scroll triggered when sending message (correct behavior)');
