    ...
    webServer: [
        {
            ...
            command: 'pwsh -NoLogo -NoProfile -Command "cd ..\\server; dotnet build -c Debug; $env:ASPNETCORE_ENVIRONMENT=\'Test\'; $env:ASPNETCORE_URLS=\'http://localhost:5099\'; $env:LLM_API_KEY=\'DUMMY\'; dotnet bin\\Debug\\net9.0\\AIChat.Server.dll"',
